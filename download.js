...
async function openDownload() {
	...
	// default language option is empty
	...
	// add languages to selector dropdown
    $("#languageChoice option").each(function () {
		...
		// disable already downloadeds dictionaries
	...
	// CG ADD - THIS FIXES THE "DUPLICATE DOWNLOADS" BUG
	$(".downloadStartButton")
	.off("click.lexin")
...
function setAsDownloaded(wrapper, lang) {
	// show info text + remove button
    // wrapper.empty().append("Nedladdat <button class='removeDownloadButton' type='button' aria-label='Ta bort nedladdning'></button>");
	wrapper.empty().append("Nedladdat <button class='removeDownloadButton' type='button' aria-label='Ta bort nedladdning'>&times;</button>");
...
async function removeLanguage(lang, progress, wantedStatus) {
	...
	// remove all the language's entries
